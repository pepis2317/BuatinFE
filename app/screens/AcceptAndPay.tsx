...
type AcceptAndPayProps = NativeStackScreenProps<
  RootStackParamList,
  "AcceptAndPay"
>;
  ...
  return (
    <View>
      <ConfirmedModal
        ...
        visible={showPaid}
        message={"Step has been paid"}
      />
      <ConfirmedModal
        onPress={() => navigation.goBack()}
        visible={showSnapPaid}
        message={"Step has been paid with snap"}
      />
      <ConfirmedModal
        onPress={() => setShowSnapFailed(false)}
        visible={showSnapFailed}
        message={"Something went wrong with the snap payment"}
      />
      ...
      />
      <ColoredButton
        title={"Pay using Midtrans"}
        onPress={() => handleSnapPay()}
      />
      <PaymentModal
