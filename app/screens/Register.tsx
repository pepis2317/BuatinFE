                    ...
                    <View style={styles.formContainer}>
                        ...
                        {role == "Seller" ?
                            <View>
                                ...
                                <ColoredButton title={"Set current position as seller location"} style={{ backgroundColor: Colors.green }} onPress={() => handleGetLocation()} />
                                {location ? <Text style={{ color: theme == "dark" ? "white" : "black" }}>Seller location set: {location.coords.latitude}, {location.coords.longitude}</Text> : <></>}
                            </View>
                            : <></>
                        }
